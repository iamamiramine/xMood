...
from domain.models.base_parameters import MultimodalBaseParameters


class MultimodalMappingParameters(BaseModel):
    """Parameters for multimodal mapping service - lightweight API model"""
...
class MultimodalTrainingParameters(MultimodalBaseParameters):
    """Parameters for training multimodal mapping models - inherits from base"""
    
    # Only additional parameters not in base classes
    num_bars: int = Field(8, description="Number of bars to generate")
    ...
    caption: bool = Field(False, description="Generate captions")
