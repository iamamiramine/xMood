...
class EncodeParameters(BaseModel):
    ...
    use_algorithm: Annotated[bool, Query(description="Whether to use the key detection algorithm or dataset key")] = True
    use_music21: Annotated[bool, Query(description="Whether to use music21's key detection")] = False
