...
from application.symbolic.helpers.remi_helper import get_time_signature, get_key_signature, get_positions_per_bar
...
def get_symbolic_features(
    ...
    symbolic_features = {"bar_symbolic": [], "piece_symbolic": []}
    symbolic_features["piece_symbolic"] = get_piece_level_symbolic_features(midi, groups)
    ...
    symbolic_features["bar_symbolic"] = [f"{e.name}_{e.value}" for e in events]
