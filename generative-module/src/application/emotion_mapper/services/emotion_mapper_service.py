...
# Vocabulary models
from application.encoder.models.vocab_model import RemiVocab, MoodsVocab
...
def train_emotion_mapper(parameters: EmotionMapperTrainingParameters) -> dict:
    ...
    # Setup checkpointing
    checkpoint_path = os.path.join(CHECKPOINTS_PATH, parameters.dataset_name, parameters.training_name)
