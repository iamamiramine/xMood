...
from domain.constants.encoder.token_constants import LOVE_KEY, BAR_KEY
...
def load_emotion_mapper_from_checkpoint(checkpoint_path: str, eval=True):
    model, _ = EmotionMapper.load_checkpoint(checkpoint_path, 512, eval)
    return model
