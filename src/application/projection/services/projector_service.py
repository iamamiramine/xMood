...
from application.encoder.models.vocab_model import EmotionVocab, SymbolicFeaturesVocab
...
def train_projector(config_path: str) -> dict:
    ...
    checkpoint_dir = os.path.join(CHECKPOINTS_PATH, datamodule_parameters.get("dataset_name"), projector_config.get("training_name"), "checkpoints")
