        ...
        try:
            ...
            for i in range(batch_size):
                ...
                item = {
                    ...
                    "note_density": batch["note_density"][i][:125] if "note_density" in batch else None,
                    "mean_velocity": batch["mean_velocity"][i][:125] if "mean_velocity" in batch else None,
                    "mean_pitch": batch["mean_pitch"][i][:125] if "mean_pitch" in batch else None,
                    "mean_duration": batch["mean_duration"][i] if "mean_duration" in batch else None,
                    "time_signature": batch["time_signature"][i] if "time_signature" in batch else None,
                    "key_signature": batch["key_signature"][i] if "key_signature" in batch else None,
